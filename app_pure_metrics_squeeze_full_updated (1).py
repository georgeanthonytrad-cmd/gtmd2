...
def get_yahoo_quote(symbol):
    """
    Extra Yahoo fallback for fundamentals.
    This endpoint often still returns P/E, forward P/E, PEG, analyst target,
    short float, and cash when quoteSummary or yfinance returns blanks.
    """
