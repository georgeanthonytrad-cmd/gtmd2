...
def generate_trade_alert(values, entry_price=np.nan):
    ...
    # SELL rules: thesis broken / risk control
    ...
    # TRIM rules: overheating / profit protection
    ...
    # BUY rules: strong setup without exit triggers
...
if mode == "Single Stock Analyzer":
    ...
    if run and symbol:
        ...
        st.write("**BUY:** Score ≥ 70, unless an exit/overheating rule is triggered.")
        st.write("**TRIM:** Position up ≥ 10%, RSI ≥ 75, or 5-day change > +8%.")
        st.write("**SELL:** Score < 55, price below 200D MA, position down ≥ 7%, or price >10% below 50D MA.")
        st.write("**WATCH:** No clean buy, trim, or sell signal.")
    else:
